...
var Auth = function (options) {
    ...
    if (options.ext) {
        if (typeof options.ext.log === 'function')
            ext.log = options.ext.log; if (typeof options.ext.hash === 'function')
    ...
    var checkUser = function (req) {
        var user = null;
        var header = req.headers['authorization']; if (header) {
            user = validate(
    ...
    */
    this.check = function (req, res, callback) {
        var user = null;//TODO Fix me - block extention
